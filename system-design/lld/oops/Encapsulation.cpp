...
public:
    ...
    // Getter and Setter methods provide an interface to access and modify the private members of a class.
    // They help in maintaining data encapsulation and providing controlled access to the object's state.
    // Example -> We can set a condition in the setter method to prevent the tyre company from being set to a value other than a specific brand.
